...
Download:  sys.sonassi.com/mage2-dbdump.sh

This script is used to dump or restore Magento2 databases by reading
the env.php file and parsing the DB credentials. It strips out
