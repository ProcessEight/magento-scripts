...
echo "Downloading latest version for PHP7.0.x..."
...
#
"
/usr/bin/phpize7.0 || exit

echo "
#
# Successfully ran /usr/bin/phpize7.0
#
...
question "Confirm that the output of phpize7.0 matches that output above:"
if [ $? -eq 0 ]; then
  echo "
#
# You chose...wisely
#
  ...
  make
  sudo cp /home/zone8/Downloads/xdebug-2.9.8/modules/xdebug.so /usr/lib/php/20151012/xdebug298.so
