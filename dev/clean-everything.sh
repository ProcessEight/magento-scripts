...
rm -rf `pwd`/htdocs/var/cache/* `pwd`/htdocs/var/generation/* `pwd`/htdocs/var/di/* `pwd`/htdocs/var/page_cache/* `pwd`/htdocs/var/tmp/* `pwd`/htdocs/var/view_preprocessed/css/frontend/* `pwd`/htdocs/var/view_preprocessed/js/frontend/* `pwd`/htdocs/var/view_preprocessed/source/frontend/*
